...
`git clone https://github.com/username/jugaad.git`
...
`git remote add upstream https://github.com/shubhamgoel24/jugaad`
...
spam the repository with unnecessary Pull Requests. Happy Hacking!
